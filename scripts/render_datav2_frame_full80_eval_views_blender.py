#!/usr/bin/env python3
"""Render full80 base/fine GLBs from fixed cameras inside Blender."""
...
def write_outputs(render_root: Path, rows: list[dict[str, Any]], summary: dict[str, Any]) -> None:
    ...
    lines = [
        "# Phase 2L.7A Full80 Render Summary",
        "",
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Render full80 eval GLB views in Blender.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("PHASE2L7A_FULL80_RENDERED_VIEWS_OK")
    return 0
