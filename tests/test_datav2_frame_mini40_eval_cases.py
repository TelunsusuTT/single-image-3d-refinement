...
from scripts import make_datav2_frame_mini40_eval_cases as cases_script
...
def make_case_setup(tmp_path: Path) -> Path:
    ...
    split_rows = [
        {"split_config": "mini40", "split": "val", "item_id": "VAL1", "local_glb_path": str(mesh_dir / "VAL1.glb")},
        {"split_config": "mini40", "split": "test", "item_id": "TEST1", "local_glb_path": str(mesh_dir / "TEST1.glb")},
        {"split_config": "mini40", "split": "train", "item_id": "TRAIN1", "local_glb_path": str(mesh_dir / "TRAIN1.glb")},
    ]
    curated_rows = [
    ...
    override_rows = [
        {"item_id": "VAL1", "selected_input_view": "004", "primary_eval_views": "004;005"},
    ]
...
def test_eval_cases_use_override_then_curated_manifest(tmp_path):
    ...
    assert by_item["TEST1"]["selected_input_view"] == "005"
